...
thingy = pd.read_csv("https://raw.githubusercontent.com/0Domlightning0/MachineLearningOffical/main/OSSLT_Eval.csv", nrows=0,skiprows=111,header=0)
...
# Creation of Linear weights and intercept with variale names in order 
writing = linear_model.LinearRegression(n_jobs=-1,fit_intercept=False)
...
# Manual version of the predict function 
#print(writing.intercept_ + writing.coef_[0] * Enrolment_Input + writing.coef_[1] * Latitude_Input + LongitudeInput * writing.coef_[2] + PercentageofStudentsWhoseFirstLanguageIsNotEnglishInput * writing.coef_[3] + PercentageofStudentsWhoseFirstLanguageIsNotFrenchInput * writing.coef_[4] + PercentageofStudentsWhoAreNewtoCanadafromaNonEnglishSpeakingCountryInput * writing.coef_[5] + PercentageofStudentsWhoAreNewtoCanadafromaNonFrenchSpeakingCountryInput * writing.coef_[6] + PercentageofStudentsReceivingSpecialEducationServicesInput * writing.coef_[7] + PercentageofStudentsIdentifiedasGiftedInput * writing.coef_[8] +PercentageofGrade3StudentsAchievingtheProvincialStandardinReadingInput* writing.coef_[9] + ChangeinGrade3ReadingAchievementOverThreeYearsInput * writing.coef_[10] + PercentageofGrade3StudentsAchievingtheProvincialStandardinWritingInput * writing.coef_[11] + ChangeinGrade3WritingAchievementOverThreeYearsInput * writing.coef_[12] + PercentageofGrade3StudentsAchievingtheProvincialStandardinMathematicsInput * writing.coef_[13] + ChangeinGrade3MathematicsAchievementOverThreeYearsInput * writing.coef_[14])
